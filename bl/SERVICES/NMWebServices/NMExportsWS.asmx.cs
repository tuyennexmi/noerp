...
namespace NEXMI
{
    ...
    public class NMExportsWS : System.Web.Services.WebService
    {
        [WebMethod]
        public NMExportsWSI callSingleWS(NMExportsWSI wsi)
        {
            NMExportsBL BL = new NMExportsBL();
            return BL.callSingleBL(wsi);
        }
        [WebMethod]
        public List<NMExportsWSI> callListWS(NMExportsWSI wsi)
        {
            NMExportsBL BL = new NMExportsBL();
