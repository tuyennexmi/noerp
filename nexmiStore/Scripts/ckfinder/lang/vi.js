...
CKFinder.lang['vi'] =
{
	...
	BasketFolder		: 'Rổ',
	BasketClear			: 'Dọn rổ',
	BasketRemove		: '<%= NEXMI.NMCommon.GetInterface("DELETE", Session["Lang"].ToString()).Name %> khỏi rổ',
	...
	Rename			: 'Đổi tên',
	Delete			: '<%= NEXMI.NMCommon.GetInterface("DELETE", Session["Lang"].ToString()).Name %>',
	...
	UploadClearFiles	: '<%= NEXMI.NMCommon.GetInterface("DELETE", Session["Lang"].ToString()).Name %> tập tin',
	UploadCancel		: 'Hủy tải',
	UploadRemove		: '<%= NEXMI.NMCommon.GetInterface("DELETE", Session["Lang"].ToString()).Name %>',
	UploadRemoveTip		: '<%= NEXMI.NMCommon.GetInterface("DELETE", Session["Lang"].ToString()).Name %> !f',
