...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        BaseUrl = Request.ApplicationPath + "/uploads/";
		...
		// checked, not only the last part. <%= NEXMI.NMCommon.GetInterface("PRINT", Session["Lang"].ToString()) %> this way, uploading foo.php.rar would be
		...
		type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "swf", "flv", "mp4", "avi", "wmv", "opp" };
		type.DeniedExtensions = new string[] { };
	}
