                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data == '') {
                            ...
                            fnSetOrderStatus(id, status, '', 'Báo giá đã được gửi');
                        }
                        else {
                            alert(data);
                        }
...
<div class="windowButtons">
    <div class="NMButtons">
        <button onclick='javascript:fnSend("<%=ViewData["Id"]%>", "<%=ViewData["Status"]%>")' class="button medium">Gửi</button>
