...
<ul class="button-group">
    ...
    <li><input readonly="readonly" data-max-page="<%=ViewData["TotalPage"]%>" data-current-page="<%=ViewData["CurrentPage"]%>" style="width: 90px; height: 21px; text-align: center; font-weight: bold; border: 1px solid #ccc;" /></li>
