                    ...
                    <tbody>
                        <% 
                            if (WSI.Details.Count > 0)
                            {
                                ...
                                {
                                    begin = WSI.Details.Where(c => (c.PartnerId == Item.Customer.CustomerId & c.IsBegin == true)).Sum(i => i.DebitAmount);                                            
                                    buyinmonth = WSI.Details.Where(c => (c.PartnerId == Item.Customer.CustomerId & c.IsBegin == false)).Sum(i => i.DebitAmount);                                            
                                    paid = WSI.Details.Where(c => (c.PartnerId == Item.Customer.CustomerId & c.IsBegin == false)).Sum(i => i.CreditAmount);
