...
%>
    <tr id="<%=Item.ProductId%>">
        ...
        <td class="actionCols">
            <button type="button" class="btActions update" onclick="javascript:fnShowPODetail('<%=Item.ProductId%>')"></button>
            <button type="button" class="btActions delete" onclick="javascript:fnRemovePODetail('<%=Item.ProductId%>')"></button>
        </td>
    </tr>
<% 
    }
