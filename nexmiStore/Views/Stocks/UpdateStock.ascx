...
<script type="text/javascript">
    ...
    function fnReloadStock() {
        ...
        LoadContentDynamic('divUpdateStockUC', 'Stocks/UpdateStockUC', { stockId: $('#slStocks').val(), categoryId: categoryId });
    }
    ...
    function fnUpdateStock() {
        $.ajax({
            type: 'POST',
            url: appPath + 'Stocks/UpdateGBProductInStock',
            ...
            <tr>
                <td>
                    <div class="NMButtons">
                        ...
                        <button onclick="javascript:fnUpdateStock()" class="color red button" ><%= NEXMI.NMCommon.GetInterface("SAVE_AND_VIEW", langId) %></button>
